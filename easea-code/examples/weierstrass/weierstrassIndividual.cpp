...
#line 25 "weierstrass.ez"

#include <math.h>

  inline static float SQR(float d)
{
  return (d*d);
}

  inline float rosenbrock( float const *x)
{
  float qualitaet;
  int i;
  int DIM = SIZE;
...
void EASEABeginningGenerationFunction(CEvolutionaryAlgorithm* evolutionaryAlgorithm){
	#line 204 "weierstrass.ez"
{
#line 100 "weierstrass.ez"
{
}
}
}
...
void ParametersImpl::setDefaultParameters(int argc, char** argv){
	...
	this->generateRScript = setVariable("generateRScript",1);
	...
	this->outputFilename = (char*)"weierstrass";
	this->plotOutputFilename = (char*)"weierstrass.png";
...
void EvolutionaryAlgorithmImpl::initializeParentPopulation(){
	if(this->params->startFromFile){
	  ifstream EASEA_File("weierstrass.pop");
	  string EASEA_Line;
